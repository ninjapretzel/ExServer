...
//			try { initializer?.Invoke(thing); } catch (Exception e) { Log.Error($"DBService.Initialize: Error in initializer of type {typeof(T)}.", e); }
...
//				if (value.IsNumeric) { obj[key] = value.AsDouble; } else if (value.IsString) { obj[key] = value.AsString; } else if (value.IsBoolean) { obj[key] = value.AsBoolean; } else if (value.IsBsonDocument) { obj[key] = FromBson(value.AsBsonDocument); } else if (value.IsBsonArray) { obj[key] = FromBson(value.AsBsonArray); } else if (value.IsBsonNull) { obj[key] = JsonNull.instance; }
//			}
...
//				if (value.IsNumeric) { arr.Add(value.AsDouble); } else if (value.IsString) { arr.Add(value.AsString); } else if (value.IsBoolean) { arr.Add(value.AsBoolean); } else if (value.IsBsonDocument) { arr.Add(FromBson(value.AsBsonDocument)); } else if (value.IsBsonArray) { arr.Add(FromBson(value.AsBsonArray)); } else if (value.IsBsonNull) { arr.Add(JsonNull.instance); }
//			}
...
//				if (value.isNumber) { doc[key] = value.doubleVal; } else if (value.isString) { doc[key] = value.stringVal; } else if (value.isBool) { doc[key] = value.boolVal; } else if (value is JsonObject) { doc[key] = ToBson(value as JsonObject); } else if (value is JsonArray) { doc[key] = ToBson(value as JsonArray); } else if (value.isNull) { doc[key] = BsonNull.Value; }
...
//				if (value.isNumber) { arr.Add(value.doubleVal); } else if (value.isString) { arr.Add(value.stringVal); } else if (value.isBool) { arr.Add(value.boolVal); } else if (value is JsonObject) { arr.Add(ToBson(value as JsonObject)); } else if (value is JsonArray) { arr.Add(ToBson(value as JsonArray)); } else if (value.isNull) { arr.Add(BsonNull.Value); }
...
//				if (pair.Value == null) { ctx.Writer.WriteNull(); } else if (pair.Value.JsonType == JsonType.String) { ctx.Writer.WriteString(pair.Value.stringVal); } else if (pair.Value.JsonType == JsonType.Number) { ctx.Writer.WriteDouble(pair.Value.doubleVal); } else if (pair.Value.JsonType == JsonType.Object) { ctx.WriteJsonObject(pair.Value as JsonObject); } else if (pair.Value.JsonType == JsonType.Array) { ctx.WriteJsonArray(pair.Value as JsonArray); } else if (pair.Value.JsonType == JsonType.Boolean) { ctx.Writer.WriteBoolean(pair.Value.boolVal); } else if (pair.Value.JsonType == JsonType.Null) { ctx.Writer.WriteNull(); }
...
//				if (item == null) { ctx.Writer.WriteNull(); } else if (item.JsonType == JsonType.String) { ctx.Writer.WriteString(item.stringVal); } else if (item.JsonType == JsonType.Number) { ctx.Writer.WriteDouble(item.doubleVal); } else if (item.JsonType == JsonType.Object) { ctx.WriteJsonObject(item as JsonObject); } else if (item.JsonType == JsonType.Array) { ctx.WriteJsonArray(item as JsonArray); } else if (item.JsonType == JsonType.Boolean) { ctx.Writer.WriteBoolean(item.boolVal); } else if (item.JsonType == JsonType.Null) { ctx.Writer.WriteNull(); }
...
//				if (nextType == BsonType.String) { value[name] = ctx.Reader.ReadString(); } else if (nextType == BsonType.Int32) { value[name] = ctx.Reader.ReadInt32(); } else if (nextType == BsonType.Int64) { value[name] = ctx.Reader.ReadInt64(); } else if (nextType == BsonType.Double) { value[name] = ctx.Reader.ReadDouble(); } else if (nextType == BsonType.Document) { value[name] = ReadJsonObject(ctx); } else if (nextType == BsonType.Array) { value[name] = ReadJsonArray(ctx); } else if (nextType == BsonType.Boolean) { value[name] = ctx.Reader.ReadBoolean(); } else if (nextType == BsonType.Null) { value[name] = JsonNull.instance; ctx.Reader.ReadNull(); } else { ctx.Reader.SkipValue(); }
...
//				// Log.Info($"Read type is [{nextType}], state is {ctx.Reader.State}");
//				if (nextType == BsonType.String) { value.Add(ctx.Reader.ReadString()); } else if (nextType == BsonType.Int32) { value.Add(ctx.Reader.ReadInt32()); } else if (nextType == BsonType.Int64) { value.Add(ctx.Reader.ReadInt64()); } else if (nextType == BsonType.Double) { value.Add(ctx.Reader.ReadDouble()); } else if (nextType == BsonType.Document) { value.Add(ctx.ReadJsonObject()); } else if (nextType == BsonType.Array) { value.Add(ctx.ReadJsonArray()); } else if (nextType == BsonType.Boolean) { value.Add(ctx.Reader.ReadBoolean()); } else if (nextType == BsonType.Null) { value.Add(JsonNull.instance); ctx.Reader.ReadNull(); } else { ctx.Reader.SkipValue(); }
